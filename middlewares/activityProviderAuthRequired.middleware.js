...
const activityProviderAuthRequired = async (req, res, next) => {
  ...
  jwt.verify(token, process.env.JWT_SECRET, async (err, decodedUser) => {
    ...
    const user = await prisma.activityProvider.findUnique({ where: { id: decodedUser.userId } });
...
module.exports = activityProviderAuthRequired;
